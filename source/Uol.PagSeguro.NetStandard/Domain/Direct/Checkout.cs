...
using System.Text;
using Uol.PagSeguro.NetStandard.Constants;
...
namespace Uol.PagSeguro.NetStandard.Domain.Direct
{
    ...
    public class Checkout
    {
        ...
        /// </summary>
        /// <remarks>
        /// The expected currency values are defined in the <c cref="T:Uol.PagSeguro.NetStandard.Domain.Currency">Currencty</c> class.
        /// </remarks>
        ...
        public Checkout()
        {
            this.Currency = Uol.PagSeguro.NetStandard.Constants.Currency.Brl;
        }
