...
using Uol.PagSeguro.NetStandard.Parse;
...
namespace Uol.PagSeguro.NetStandard.Service
{
    ...
    public static class PreApprovalSearchService
    {
        ...
        /// <returns cref="T:Uol.PagSeguro.NetStandard.Transaction"><c>Transaction</c></returns>
        ...
        /// <returns cref="T:Uol.PagSeguro.NetStandard.PreApprovalSearchResult"><c>PreApprovalSearchResult</c></returns>
